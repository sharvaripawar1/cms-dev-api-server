# Generated by Django 3.1.2 on 2021-04-26 09:53
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('portal', '0004_auto_20210423_1057'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel_ref_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='portal.tbl_channel_mst', verbose_name='Channel Ref Id')),
                ('header_ref_id', models.ForeignKey(default=0, on_delete=django.db.models.deletion.PROTECT, related_name='initialItemRow', to='portal.tbl_company_application_link_mst', verbose_name='Header Ref ID')),
            ],
        ),
        migrations.AddConstraint(
            model_name='tbl_company_application_link_mst',
            constraint=models.UniqueConstraint(condition=models.Q(is_deleted='N'), fields=('name',), name='tbl_company_application_link_mst unique if not deleted'),
        ),
    ]
